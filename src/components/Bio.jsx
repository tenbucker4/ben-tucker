			...
			<div className='bio-container'>
				...
				<div className="bio-left">
					...
					<p>I'm a formally educated chemist (M.Sc.) and a self-taught frontend developer.
						I love solving problems, learning, and building intuitive, visually-appealing products.
					...
					<p>I'm open to job oppportunities where I can contribute to big ambitious projects and grow as a developer.
						If you have an opportunity that matches my skillset, please don't hesitate to contact me. If you'd like
						to learn some more about my professional experience, you can download my resume here.</p>
				</div>
